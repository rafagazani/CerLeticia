...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { data_nascimento: @paciente.data_nascimento, img: @paciente.img, nome: @paciente.nome, sexo: @paciente.sexo }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { data_nascimento: @paciente.data_nascimento, img: @paciente.img, nome: @paciente.nome, sexo: @paciente.sexo }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
